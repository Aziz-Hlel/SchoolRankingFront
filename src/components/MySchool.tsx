...
import { School, Users, Building, BookOpen, Award, Edit } from 'lucide-react';
...
export const MySchool: React.FC = () => {
    ...
    switch (selectedSection) {
      ...
      case 'academic':
        return (
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              <h4 className="font-semibold text-lg">Academic Programs</h4>
              <Button 
                variant="outline" 
                size="sm"
      ...
      case 'facilities':
        return (
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              <h4 className="font-semibold text-lg">Facilities & Resources</h4>
              <Button 
                variant="outline" 
                size="sm"
      ...
      case 'staff':
        return (
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              <h4 className="font-semibold text-lg">Staff & Leadership</h4>
              <Button 
                variant="outline" 
                size="sm"
                onClick={() => setEditingSection('staff')}
              >
                <Edit className="w-4 h-4 mr-2" />
                Edit
              </Button>
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-3xl font-bold tracking-tight">My School</h2>
          <p className="text-muted-foreground">View and manage your school information</p>
        </div>
      </div>
